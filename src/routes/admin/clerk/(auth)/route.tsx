...
import { ClerkFullLogo } from '@admin/assets/clerk-full-logo'
import { Logo } from '@admin/assets/logo'
import { LearnMore } from '@admin/components/learn-more'

export const Route = createFileRoute('/admin/clerk/(auth)')({
