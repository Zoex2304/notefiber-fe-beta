...
import { LearnMore } from '@admin/components/learn-more'
import { Search } from '@admin/components/search'
import { ThemeSwitch } from '@admin/components/theme-switch'
import { UsersDialogs } from '@admin/features/users/components/users-dialogs'
import { UsersPrimaryButtons } from '@admin/features/users/components/users-primary-buttons'
import { UsersProvider } from '@admin/features/users/components/users-provider'
import { UsersTable } from '@admin/features/users/components/users-table'
import { users } from '@admin/features/users/data/users'

export const Route = createFileRoute('/admin/clerk/_authenticated/user-management')({
...
function Unauthorized() {
  ...
  useEffect(() => {
    ...
    navigate({ to: '/admin/clerk/sign-in' })
  }, [countdown, navigate])
    ...
    <div className='h-svh'>
      <div className='m-auto flex h-full w-full flex-col items-center justify-center gap-2'>
        ...
        <div className='mt-6 flex gap-4'>
          ...
          <Button onClick={() => navigate({ to: '/admin/clerk/sign-in' })}>
