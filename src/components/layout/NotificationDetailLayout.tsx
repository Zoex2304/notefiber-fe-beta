...
export function NotificationDetailLayout({
    ...
    if (error) {
        return (
            <div className="min-h-full w-full bg-background p-6 lg:p-10 flex flex-col items-center justify-center">
    ...
    return (
        <div className="min-h-full w-full bg-background p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                {/* Main Content Card */}
                <Card className={cn(
                    "border-0 shadow-lg bg-card/90 backdrop-blur-xl overflow-hidden rounded-2xl ring-1 ring-black/5 dark:ring-white/10",
                    status?.cardBorder
                )}>
                    {status && (
                        <div className="border-b border-border bg-muted/50 p-6 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                            <div className="flex items-center gap-3">
